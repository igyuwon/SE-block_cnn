...
model.load_state_dict(torch.load("EfficientNet_b0_saved_model.pth"))
...
plt.title('Confusion Matrix (EfficentNet_b0)')
plt.colorbar()
...
plt.savefig('EfficentNet_b0_confusion_matrix.png')