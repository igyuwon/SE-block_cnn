...
model = DenseNetWithSE(num_classes).to(device)

model.load_state_dict(torch.load("SE_DenseNet_saved_model.pth"))
...
plt.savefig('SE_DenseNet_confusion_matrix.png')